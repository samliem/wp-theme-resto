<form id="setting-social" method="post" action="options.php" 
    <?php if( 'social' != $_COOKIE['resto_tab'] ) echo 'class="hide"'; ?>>
    <?php 
    ...
    <table class="form-table">
        <tr valign="top">
            ...
            <td>
                <input type="text" id="facebook-url" name="jrl_resto_theme_options[facebook]"
        ...
        <tr valign="top">
            ...
            <td>
                <input type="text" id="twitter-url" name="jrl_resto_theme_options[twitter]"
