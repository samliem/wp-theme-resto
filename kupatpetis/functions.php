<?php
    ...
    function custom_twentytwelve_widgets_init() {
	register_sidebar( array(
		'name' => __( 'Main Sidebar', 'twentytwelve' ),
		'id' => 'sidebar-1',
		'description' => __( 'Appears on posts and pages except the optional Front Page template, which has its own widgets', 'twentytwelve' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s"><div class="content-wrap">',
    ...
    //This action replaces function twentytwelve_widgets_init of parent's theme
    //Don't forget to put priority bigger than 10 otherwise this function will
    //be replaced by twentytwelve_widgets
    add_action( 'widgets_init', 'custom_twentytwelve_widgets_init', 20 );
    ...
    add_action( 'template_redirect', 'custom_twentytwelve_content_width', 20 );
   ...
   /************ Js untuk upload image menggunakan media upload *************/
    ...
    function insert_wc_opening_div() {
        echo '<div class="content-wrap">';
    }
    add_action('woocommerce_before_main_content', 'insert_wc_opening_div');
    
    function insert_wc_closing_div() {
        echo '</div>';
    }
    add_action('woocommerce_after_main_content', 'insert_wc_closing_div');
    ...
    function insert_wc_loading_img() {
        //Menampilkan loading image selama resizing gambar thumbnail
    ...
    /* Mengubah susunan agar rating ada di bawah price */
    ...
    function custom_woocommerce_result_count($default_message, $total) {
        ...
        if( is_home() || is_front_page() ) {
            $default_message = '<div class="ribbon-title"></div><div class="archive-product-title">';
            if( 1 == $total ) {
    ...
    /*-- Mengubah susunan antara harga dan excerpt --*/
    ...
    //lightbox untuk thumbnail pada single product
