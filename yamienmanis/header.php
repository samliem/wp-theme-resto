...
<body <?php body_class(); ?>>
	...
	<header id="masthead" class="site-header" role="banner">
            <hgroup>
                ...
                <div id="resto-address">
                    <?php 
                            if ( !empty($jrl_theme_options['delivery']) ) : ?>
                                <div class="contact delivery">Delivery : <?php echo $jrl_theme_options['delivery']; ?></div>
                            <?php endif; 
                            
                            if( !empty($jrl_theme_options['phone']) ) : ?>
                                <div class="contact phone">Phone : <?php echo $jrl_theme_options['phone']; ?></div>
                            <?php endif;                        
                                                        
                            if( !empty($jrl_theme_options['fax']) ) : ?>
                                <div class="contact fax">Fax : <?php echo $jrl_theme_options['fax']; ?></div>
                            <?php endif;
                            
                            if( !empty($jrl_theme_options['bbm']) ) : ?>
                                <div class="contact phone">Pin BB : <?php echo $jrl_theme_options['bbm']; ?></div>
                            <?php endif;
