<form id="setting-slider" method="post" action="options.php" enctype="multipart/form-data"
    <?php if( 'slider' != $_COOKIE['resto_tab'] ) echo 'class="hide"'; ?>>
    <a href="#" id="add-slide" class="jrl-button add">Tambah Slide</a>
    <div id="sliders">
    <?php 
    settings_fields('jrl_resto_theme_options'); 
    ...
    <?php if( $sliders_url ) :
            ...
            <div id="slider_<?php echo $i; ?>" class="slider">
                ...
                <div class="tb-cell slider-img">
                    <input type="hidden" id="slider-url_<?php echo $i;?>" class="slider-url" 
                        name="jrl_resto_theme_options[slider_img][]" 
                ...
                <div class="tb-cell">
                    <div>
                        ...
                        <input type="text" id="slider-post-id" name="jrl_resto_theme_options[slider_post][]" 
                            value="<?php echo $jrl_theme_options['slider_post'][$i]; ?>"/>
                    </div>
                    <div>
                        <label for="slider-title" size="10">Judul :</label>
                        <input type="text" id="slider-title" name="jrl_resto_theme_options[slider_title][]" 
        ...
        <div id="slider_0" class="slider">
            ...
            <div class="tb-cell slider-img">
                <input type="hidden" id="slider-url_0" class="slider-url" name="jrl_resto_theme_options[slider_img][]" value="" />
...
<div class="template">
    ...
    <div class="tb-cell slider-img">
        <input type="hidden" class="slider-url" name="jrl_resto_theme_options[slider_img][]" 
            value="" />
