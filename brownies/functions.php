   ...
   /************ Js untuk upload image menggunakan media upload *************/
    ...
    function brownies_html_before_header() {
        ...
        if( !empty($jrl_theme_options['phone']) ) 
            echo '<div class="contact phone">' . $jrl_theme_options['phone'] . '</div>';
        
        if( !empty($jrl_theme_options['delivery']) )
            echo '<div class="contact delivery">&nbsp; &sect; &nbsp; Delivery : ' . $jrl_theme_options['delivery'] . '</div>';
        
        if( !empty($jrl_theme_options['bbm']) )
            echo '<div class="contact bbm">&nbsp; &sect; &nbsp; Pin BB : ' . $jrl_theme_options['bbm'] . '</div>';
        
        if( !empty($jrl_theme_options['fax']) )
            echo '<div class="contact fax">&nbsp; &sect; &nbsp; Fax : ' . $jrl_theme_options['fax'] . '</div>';
            
        echo '</div></div>';
    }
    add_action('jrl_before_header', 'brownies_html_before_header');
    ...
    //lightbox untuk product image pada single product
