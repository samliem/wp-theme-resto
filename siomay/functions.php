<?php
   ...
   /************ Js untuk upload image menggunakan media upload *************/
    ...
    //Mengubah urutan rating agar berada di bawah 
    remove_action( 'woocommerce_after_shop_loop_item_title', 'woocommerce_template_loop_rating', 5 );
    add_action( 'woocommerce_after_shop_loop_item_title', 'woocommerce_template_loop_rating', 15 );
    
    function custom_woocommerce_result_count($default_message, $total) {
        
        $default_message = '<div id="menu-left"><div id="menu-right"><div id="menu-mid">';
    ...
    //lightbox untuk thumbnail pada single product -> line 482
